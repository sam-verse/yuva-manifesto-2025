      ...
      <footer className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white pt-16 pb-12 md:pt-20 md:pb-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-6xl">
          ...
          >
            ...
            >
              {[
                { name: 'linkedin', icon: 'in', color: 'from-blue-500 to-blue-600', hoverColor: 'hover:from-blue-600 hover:to-blue-700', glowColor: 'shadow-[0_0_15px_rgba(59,130,246,0.3)]' },
                { name: 'github', icon: 'gh', color: 'from-gray-700 to-gray-800', hoverColor: 'hover:from-gray-800 hover:to-gray-900', glowColor: 'shadow-[0_0_15px_rgba(31,41,55,0.3)]' },
                { name: 'twitter', icon: '𝕏', color: 'from-sky-400 to-sky-500', hoverColor: 'hover:from-sky-500 hover:to-sky-600', glowColor: 'shadow-[0_0_15px_rgba(14,165,233,0.3)]' },
                { name: 'mail', icon: '✉', color: 'from-amber-400 to-amber-500', hoverColor: 'hover:from-amber-500 hover:to-amber-600', glowColor: 'shadow-[0_0_15px_rgba(245,158,11,0.3)]' },
                { name: 'dribbble', icon: 'd', color: 'from-pink-500 to-rose-500', hoverColor: 'hover:from-pink-600 hover:to-rose-600', glowColor: 'shadow-[0_0_15px_rgba(236,72,153,0.3)]' },
              ].map((social, index) => (
                <motion.a
                  key={social.name}
                  href={`#${social.name}`}
                ...
                >
                  ...
                  <div className={`w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-2xl bg-gradient-to-br ${social.color} ${social.hoverColor} ${social.glowColor} group-hover:shadow-xl transition-all duration-300 group-hover:rotate-6 relative overflow-hidden`}>
                    <span className="text-white text-xl sm:text-2xl font-medium relative z-10">{social.icon}</span>
                    <motion.div
                    ...
                    />
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-br from-white/0 via-white/10 to-white/0 opacity-0 group-hover:opacity-100"
                  ...
                  <span className="absolute -bottom-7 left-1/2 -translate-x-1/2 text-xs font-medium text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
